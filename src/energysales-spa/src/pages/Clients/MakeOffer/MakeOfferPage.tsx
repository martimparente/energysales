import {Badge, Box, Button, Card, Group, Slider, Stack, Text, Title, useMantineTheme} from '@mantine/core'
...
export function MakeOfferPage() {
    ...
    return (
        <Box p='md'>
                                ...
                                {expandedService === service.id && (
                                    <div>
                                        <Group justify='space-between'>
                                            ...
                                            <Button onClick={() => handleSelectService(service.id)}>Select Service</Button>
                                        </Group>
                                    </div>
                                )}
                            </Card>
            ...
            {selectedService && (
                <div>
                    <Button onClick={handleDeselectService}>Deselect Service</Button>
            ...
            {offerResponse ? (
                <div>
                    ...
                    <Group mt='md'>
                        <Button onClick={() => handleCopyToClipboard(offerResponse.url)}>Copy to Clipboard</Button>
