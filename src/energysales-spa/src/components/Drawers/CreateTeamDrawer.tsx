...
import {useCreateTeamPage} from '../../pages/Teams/CreateTeam/useCreateTeamPage.tsx'
...
export const CreateTeamDrawer: React.FC<CreateTeamDrawerProps> = ({opened, onClose}) => {
    const {
        availableUsers,
        portugalDistricts,
        handleOnUsersSearch,
        ...
        <Drawer opened={opened} onClose={onClose} title='Create Team' padding='sm' size='sm' position='right'>
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                <Controller
                    name='name'
                    control={control}
                    render={({field}) => <TextInput label='Team Name' placeholder='Enter team name' {...field} required
                                                    mb='sm'/>}
                />
                <Controller
